...
- `SPRING_ENDPOINT_SECURITY` now also treats request-mapped interface or base-class methods as endpoint signatures when the implementing controller method omits a local mapping annotation
